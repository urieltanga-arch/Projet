...
<div class="min-h-screen" style="background-color: #E8DCC8;">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-2" style="color: #1a1a1a;">Mini-Jeux & Événements</h1>
            <p class="text-lg" style="color: #4a4a4a;">Amusez-vous et gagnez des points</p>
        </div>

        <!-- Section Mini-jeux -->
        <div class="mb-12">
            <h2 class="text-2xl font-bold mb-6" style="color: #1a1a1a;">Mini-jeux Disponibles</h2>
        ...
        <div class="mb-12">
            <h2 class="text-2xl font-bold mb-6" style="color: #1a1a1a;">Événements à venir</h2>
