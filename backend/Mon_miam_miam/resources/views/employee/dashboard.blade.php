...
<body class="bg-gradient-to-br from-amber-50 to-orange-50 min-h-screen">
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="space-y-4 max-h-96 overflow-y-auto">
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition cursor-pointer" 
                         onclick="window.location.href='{{ route('employee.commandes') }}?commande={{ $activite['id'] }}'">
        ...
        <div class="mt-8 flex gap-4">
            <a href="{{ route('employee.commandes') }}" class="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl p-6 hover:shadow-xl transition">
